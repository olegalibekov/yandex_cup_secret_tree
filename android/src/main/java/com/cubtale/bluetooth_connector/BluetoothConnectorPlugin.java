 ...
 */
public class BluetoothConnectorPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "bluetooth_connector");
        ...
        receiveMessages = new EventChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(),
                "recieved_message_events");
        ...
        switch (call.method) {
            ...
            case "startClient":
                try {
                    ...
                    clientClass = new ClientClass(btDevices[index], isSecure);
                    clientClass.start();
                    result.success(true);
                } catch (Exception except) {
                    result.success(false);
    ...
    private String checkBluetoothOnOff(Result result) {
        try {
            clientClass.socket.getInputStream().close();
            clientClass.socket.getOutputStream().close();
